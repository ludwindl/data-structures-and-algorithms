...
const standardizePhoneNumbers = (arr) => {
  // Solution code here...
  return arr.map(str => {
    let arr1 = str.substring(1, 4);
    let arr2 = str.substring(6, 9);
    let arr3 = str.substring(10, 14);
...
const onlyOddChars = (str) => {
  ...
  for(var i = 0; i < str.length; i++){
    if (i % 2){
      newArray.push(str.substring(i, (i+1)));
    }
  }
...
const allHappy = (arr) => {
  // Solution code here...
  let bool = arr.map(str => str.includes(':)'));
...
const findEvery = (arr, target) => {
  // Solution code here...
  let bool = arr.map(str => str.includes(target));
  return bool.includes(false) ? false : true;
