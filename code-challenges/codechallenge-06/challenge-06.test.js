...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach((element) => { 
    if (element.name === character){
      let couple = Object.values(element);
      if (couple[2].length > 0){
        value = true;
      }
    }
  });
...
const hasChildrenEntries = (arr, character) => {
  ...
  arr.forEach((element) => { 
    if (element.name === character){
      let couple = Object.entries(element);
      if (couple[2][1].length > 0){
        value = true;
      }
    }
  });
...
const totalCharacters = (arr) => {
  ...
  let totalChar = [];
  arr.forEach(element => {
    let char = (Object.values(element));
    char.pop();
    totalChar.push(char[0]);
    if (char[1]){
      totalChar.push(char[1]);
    }
    if (char[2].length > 0){
      char[2].forEach(element =>{
        totalChar.push(element);
      });
    }
  });
